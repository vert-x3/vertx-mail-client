...
public class AuthCramSHA1Test {
  ...
  public void testAuthCramSHA1() {
    final AuthOperation auth = new AuthCram("CRAM-SHA1", "xxx", "yyy");
  ...
  public void testGetName() {
    assertEquals("CRAM-SHA1", new AuthCram("CRAM-SHA1", "xxx", "yyy").getName());
  }
  ...
  public void testNextStep2() {
    final AuthOperation auth = new AuthCram("CRAM-SHA1", "user", "key");
    assertEquals("", auth.nextStep(null));
