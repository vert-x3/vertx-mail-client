...
public class AuthCramSHA256Test {
  ...
  public void testAuthCramSHA256() {
    final AuthOperation auth = new AuthCram("CRAM-SHA256", "xxx", "yyy");
  ...
  public void testGetName() {
    assertEquals("CRAM-SHA256", new AuthCram("CRAM-SHA256", "xxx", "yyy").getName());
  }
  ...
  public void testNextStep2() {
    final AuthOperation auth = new AuthCram("CRAM-SHA256", "user", "key");
    assertEquals("", auth.nextStep(null));
