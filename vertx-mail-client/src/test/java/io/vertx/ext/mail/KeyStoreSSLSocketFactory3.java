 ...
 */
public class KeyStoreSSLSocketFactory3 extends SSLSocketFactory {

  private static final String KEY_STORE_FILE = "src/test/resources/certs/server3.jks";
   ...
   * @throws IOException
   */
  public KeyStoreSSLSocketFactory3() throws GeneralSecurityException, IOException {
